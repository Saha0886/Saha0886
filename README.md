<img width="60" height="60" alt="Lilo And Stitch Hello GIF" src="https://github.com/user-attachments/assets/4b8b5ac6-dcc6-4e77-a3bd-184b147bda6b" />  Привет, я Александр
18 лет · студент НТК им. Покрышкина · 3 курс

🚀 Обо мне
Занимаюсь робототехникой и техническим 3D-моделированием.

С нуля спроектировал, собрал и запрограммировал марсоход, вдохновлённый Curiosity.

Работал с ROS 1 и ROS 2.

Сейчас разрабатываю руковидный захват (антропоморфный захват).

🏆 Достижения
🥈 2 место на региональном этапе чемпионата

по компетенции «Эксплуатация сервисных роботов»

🛠 Чем занимаюсь

Проектирование и сборка мобильных роботов
Техническое 3D-моделирование
ROS 1 / ROS 2
Разработка манипуляторов и захватов
Интеграция сенсоров и систем управления
...
<img width="296" height="296" alt="Lizard Hello GIF" src="https://github.com/user-attachments/assets/e96c86a4-8fd4-4304-a27b-bc11a31105bb" />
